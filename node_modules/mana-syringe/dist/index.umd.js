(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  function toRegistryOption(options) {
    var token = exports.Utils.toArray(options.token);
    var useClass = exports.Utils.toArray(options.useClass);
    var useDynamic = exports.Utils.toArray(options.useDynamic);
    var useFactory = exports.Utils.toArray(options.useFactory);
    var contrib = exports.Utils.toArray(options.contrib);
    ...
    _createClass(Register, [{
      ...
      value: function resolveMono(register) {
        ...
        if (this.option.useDynamic.length > 0) {
          ...
          return bindLifecycle(bindMonoToken(this.generalToken, register).toDynamicValue(function (ctx) {
            var container = Container$1.getContainer(ctx.container);
            return dynamic({
              container: container
            });
          }), this.option);
        ...
        try {
          ...
          if (exports.Utils.isClass(target)) {
            if (!option.useClass) {
              ...
              var classes = exports.Utils.toArray(option.useClass);
          ...
          if (!mixedOption.token) {
            ...
            var tokens = exports.Utils.toArray(mixedOption.token);
      ...
      value: function resolveOption(iRegister, baseOption) {
        ...
        parsedOption.token.forEach(function (token) {
          var register = new Register(iRegister, token, _objectSpread2({}, parsedOption));
          register.resolve();
        });
      }
    }]);
  ...
  var Container$1 = /*#__PURE__*/function () {
    function Container$1(inversifyContainer) {
      ...
      Container$1.setContainer(this.container, this);
    }
    ...
    _createClass(Container$1, [{
      ...
      value: function getContainer(key) {
        ...
        if (!exist) {
          var container = new Container$1(key);
          Container$1.setContainer(key, container);
          return container;
        }
